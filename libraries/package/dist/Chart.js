 ...
 */
  var exports$1 = {
    ...
    drawPoint(ctx, style, radius, x, y, rotation) {
 ...
 */
  ...
  var controller_bar = core_datasetController.extend({
	 ...
	 * @private
	 */
    _updateElementGeometry(rectangle, index, reset) {
      var me = this;
  ...
  var controller_doughnut = core_datasetController.extend({
	 ...
	 * @private
	 */
    _resolveElementOptions(arc, index) {
      var me = this;
      var chart = me.chart;
      var dataset = me.getDataset();
 ...
 */
  ...
  var scale_time = core_scale.extend({
	 ...
	 * @private
	 */
    tickFormatFunction(time, index, ticks, format) {
      var me = this;
      var adapter = me._adapter;
      var options = me.options;
